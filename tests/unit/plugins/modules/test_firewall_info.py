...
from .test_firewall import FetchUrlCall, run_module_success, run_module_failed
...
def test_absent(mocker):
    result = run_module_success(mocker, firewall_info, {
        'hetzner_user': '',
        'hetzner_password': '',
        'server_ip': '1.2.3.4',
    }, [
...
def test_wait_get_timeout(mocker):
    result = run_module_failed(mocker, firewall_info, {
        'hetzner_user': '',
        'hetzner_password': '',
        'server_ip': '1.2.3.4',
        'wait_for_configured': True,
